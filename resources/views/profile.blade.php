                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center">
                                ...
                                <h5 class="font-weight-bold">YETKİ : ADMIN</h5>
                                <p>Okul ID:{{  Auth::user()->school_id }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                ...
                                <span class="description">Öğrenci</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                <span class="heading">10</span>
                                <span class="description">Sınav</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                <span class="heading">89</span>
                                <span class="description">Okul</span>
                            </div>
                        </div>
                    </div>
                </div>
